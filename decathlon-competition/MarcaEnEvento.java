...
public abstract class MarcaEnEvento {
    ...
    public abstract void calcularPuntosEvento(double A, double B, double C, double marca);
        ...
        switch (this.evento){
                ...
                case 0:
                case 4:
                    this.puntos =  (int) (PARAM[this.evento][A] * Math.pow((PARAM[this.evento][B] - this.marca), PARAM[this.evento][C]));;
                    return CALCULO_EVENTO_OK;
                    
                case 1:
                case 2:
                case 3:
                    this.puntos = (int) (PARAM[this.evento][A]* Math.pow((this.marca - PARAM[this.evento][B]), PARAM[this.evento][C]));;
                    return CALCULO_EVENTO_OK;
                
                default:
                    return CALCULO_EVENTO_KO_MARCA_NEGATIVA; //DICE: Si la marca es negativa debe devolver -1 en lugar de 0; expected:<-1> but was:<0>
        }*/
        //throw new UnsupportedOperationException("MarcaEnEvento::calcularPuntosEvento(...) NO se ha implementado");
    ...
    public String toString() {
        switch (this.evento){
            case 0:
                return "100 metros lisos:     marca=" + this.marca + " " +getUnidadMarcaEnEvento(this.evento)+ ", puntos=" + getPuntos() + "\n";
                
            case 1:
                return "Salto de longitud:    marca=" + this.marca + " " +getUnidadMarcaEnEvento(this.evento)+ ", puntos=" + getPuntos() + "\n";
            
            case 2:
                return "Lanzamiento de peso:  marca=" + this.marca + " " +getUnidadMarcaEnEvento(this.evento)+ ", puntos=" + getPuntos() + "\n";
                
            case 3:
                return "Salto de altura:      marca=" + this.marca + " " +getUnidadMarcaEnEvento(this.evento)+ ", puntos=" + getPuntos() + "\n";
                
            case 4:
                return "400 metros lisos:    marca=" + this.marca + " " +getUnidadMarcaEnEvento(this.evento)+ ", puntos=" + getPuntos() + "\n";
